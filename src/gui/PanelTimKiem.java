...
public class PanelTimKiem extends JPanel {
    ...
    public PanelTimKiem() {
        ...
        cbxTim.setModel(new DefaultComboBoxModel<>(new String[] { "Tìm kiếm nhân viên", "Tìm kiếm khách hàng", "Tìm kiếm món ăn", "Tìm kiếm thẻ thành viên", "Tìm kiếm tài khoản" }));
